                        <div flex="100" flex-gt-md="50" class="home-copy-content" flex-order="2" flex-order-gt-md="1"  layout="column" style="text-align:center;">
							...
							<?php /**/ ?>
							<div class="insect-filter-categories center-content mobile-padding" style="" layout-gt-md="row" layout-align-gt-md="center center" >
								<md-button
							...
							<?php /**/?>
							<div class="center-content" style="width:100%;"  layout-gt-md="row" layout-align-gt-md="center center" style="margin:40px auto;text-align:center;">
							...
							<div class="" layout="column">
								...
								<div layout-gt-md="row" layout-fill layout-align="center center" style="margin:50px auto;margin-bottom:0;">
						...
						<div flex="100" flex-offset-gt-md="10" flex-gt-md="40" flex-order="1" flex-order-gt-md="2" class="" style="" layout-align="center center">
