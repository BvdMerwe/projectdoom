...
define( function ( require, exports, module ) {
    ...
    Utils.prototype =  {
       ...
       isPhone: function ( phone ) {
        ...
        scrollWithEase: function(to, callback, duration) {
            ...
            // because it's so fucking difficult to detect the scrolling element, just move them all
                ...
                animateScroll();
            }(to, callback, duration));
        },
		scrollWindowTo: function (to, duration) {
            var _self = this;
            var newPos = window.scrollY;
			var difference = to - newPos;
            var perTick = difference / duration * 10;

            setTimeout( function(){

                newPos = newPos + perTick;

                if( newPos == to ) {
                    return;
                }
				window.scrollTo(0, newPos );
                _self.scrollWindowTo ( to, duration - 10 );
        ...
        scrollTo: function ( element, to, duration ) {
            ...
            setTimeout( function(){
                ...
                element.scrollTop = (element.scrollTop + perTick).toFixed(0);
